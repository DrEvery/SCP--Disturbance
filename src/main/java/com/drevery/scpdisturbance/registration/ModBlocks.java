...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> METAL_DOOR = registerBlock("metal_door",
            () -> new DoorBlock(BlockBehaviour.Properties.of(Material.METAL).strength(2f).harvestLevel(2).sound(SoundType.METAL)
                    .noOcclusion()));

    public static final RegistryObject<Block> MEAT_DOOR = registerBlock("meat_door",
            () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(-1F).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> MEAT_TABLE = registerBlock("meat_table",
            () -> new MeatTable(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> TABLE_A = registerBlock("table_a",
            () -> new TableA(BlockBehaviour.Properties.of(Material.DIRT).strength(-1F).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> BONE_BLOCKS = registerBlock("bone_blocks",
            () -> new BoneBlocks(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f).harvestLevel(1).sound(SoundType.BONE_BLOCK)
                    .noOcclusion().noCollission()));

    public static final RegistryObject<Block> MEAT_RADIO = registerBlock("meat_radio",
            () -> new MeatRadio(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> MEAT_BED = registerBlock("meat_bed",
            () -> new MeatBed(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> MEAT_TV = registerBlock("meat_tv",
            () -> new MeatTV(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f)));
    ...
    public static final RegistryObject<Block> BONE_DINOSAUR = registerBlock("bone_dinosaur",
            () -> new BoneDinosaur(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f).harvestLevel(1).sound(SoundType.BONE_BLOCK)
                    .noOcclusion()));
    ...
    public static final RegistryObject<Block> MEAT_LAMP = registerBlock("meat_lamp",
            () -> new MeatLamp(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion().lightLevel((state) -> 12)));

    public static final RegistryObject<Block> MEAT_COUCH_CENTER = registerBlock("meat_couch_center",
            () -> new MeatCouchCenter(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> GENERATOR = registerBlock("generator",
            () -> new Generator(BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(2f).harvestLevel(1).sound(SoundType.METAL)
                    .noOcclusion()));

    public static final RegistryObject<Block> SKIN_BOOKSHELF = registerBlock("skin_bookshelf",
            () -> new SkinBookshelf(BlockBehaviour.Properties.of(Material.WOOD).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> MEAT_NIGHTSTAND = registerBlock("meat_nightstand",
            () -> new MeatNightstand(BlockBehaviour.Properties.of(Material.WOOD).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> MEAT_PAINTING = registerBlock("meat_painting",
            () -> new Painting(BlockBehaviour.Properties.of(Material.WOOD).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> FLOOR_TRAP = registerBlock("floor_trap",
            () -> new FloorTrap(BlockBehaviour.Properties.of(Material.WOOD).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noCollission()));

    public static final RegistryObject<Block> BEAR = registerBlock("bear",
            () -> new Bear(BlockBehaviour.Properties.of(Material.DIRT).strength(-1f).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    public static final RegistryObject<Block> INDUSTRIAL_LAMP = registerBlock("industrial_lamp",
            () -> new IndustrialLamp(BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(2f).harvestLevel(1).sound(SoundType.METAL)
                    .noOcclusion().lightLevel((state) -> 12)));

    public static final RegistryObject<Block> SKIN_DOOR = registerBlock("skin_door",
            () -> new DoorBlock(BlockBehaviour.Properties.of(Material.DIRT).strength(-1F).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    //SCP-058
    public static final RegistryObject<Block> SCP_058_EGG = registerBlock("scp_058_egg",
            () -> new SCP058Egg(BlockBehaviour.Properties.of(Material.EGG).strength(-1F).harvestLevel(1).sound(SoundType.SLIME_BLOCK)
                    .noOcclusion()));

    //SCP-416
    public static final RegistryObject<Block> FENCE_BOTTOM = registerBlock("fence_bottom",
            () -> new FenceDown(BlockBehaviour.Properties.of(Material.METAL).strength(3F).harvestLevel(3).sound(SoundType.METAL)
                    .noOcclusion()));

    public static final RegistryObject<Block> FENCE_MIDDLE = registerBlock("fence_middle",
            () -> new FenceMiddle(BlockBehaviour.Properties.of(Material.).strength(3F).harvestLevel(3).sound(SoundType.METAL)
                    .noOcclusion()));

    public static final RegistryObject<Block> FENCE_TOP = registerBlock("fence_top",
            () -> new FenceTop(BlockBehaviour.Properties.of(Material.METAL).strength(3F).harvestLevel(3).sound(SoundType.METAL)
                    .noOcclusion()));

    public static final RegistryObject<Block> BARBED_WIRE = registerBlock("barbed_wire",
            () -> new BarbedWire(BlockBehaviour.Properties.of(Material.METAL).strength(3F).harvestLevel(3).sound(SoundType.METAL)
                    .noOcclusion()));

    public static final RegistryObject<Block> FENCE_GATE_METAL_416 = registerBlock("fence_gate_metal_416",
            () -> new FenceGateMetal416(BlockBehaviour.Properties.of(Material.METAL).strength(3f).harvestLevel(3).sound(SoundType.METAL)
                    .noOcclusion()));

    public static final RegistryObject<Block> GRANDIDIER_WOOD = registerBlock("grandidier_wood",
            () -> new BaseHorizontalBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(1f).harvestLevel(0).sound(SoundType.WOOD)
                    .noOcclusion()));
    ...
    public static final RegistryObject<Block> SCP_902 = registerBlock("scp_902",
            () -> new SCP902(BlockBehaviour.Properties.of(Material.METAL).strength(1f).harvestLevel(0).sound(SoundType.METAL)
                    .noOcclusion()));
